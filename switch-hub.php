<?php 
  ...
  $assets = query("SELECT * FROM tbinvenit WHERE kategori = 'Switch / Hub' ORDER BY id DESC");

  // pagination
  $numberOfDataPerPage = 10;
  $result = mysqli_query($db, "SELECT * FROM tbinvenit WHERE kategori = 'Switch / Hub'");
  ...
  $assets = query("SELECT * FROM tbinvenit WHERE kategori = 'Switch / Hub' ORDER BY id DESC LIMIT $beginningData, $numberOfDataPerPage");
      ...
      <div class="offcanvas-body">
        <ul class="list-group">
          ...
          <li class="list-group-item active">
            <a href="switch-hub.php" style="color: #fff; text-decoration: none;">
