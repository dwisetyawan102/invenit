<?php 
  ...
  $assets = query("SELECT * FROM tbinvenit WHERE kategori = 'Tools' ORDER BY id DESC");

  // pagination
  $numberOfDataPerPage = 10;
  $result = mysqli_query($db, "SELECT * FROM tbinvenit WHERE kategori = 'Tools'");
  ...
  $assets = query("SELECT * FROM tbinvenit WHERE kategori = 'Tools' ORDER BY id DESC LIMIT $beginningData, $numberOfDataPerPage");
        ...
        <ul class="list-group">
          ...
          <li class="list-group-item">
            <a href="router-ap.php" style="color: #000; text-decoration: none;">
              <i class="bi bi-router-fill"></i> Router / AP
            </a>
          </li>
          <li class="list-group-item">
          ...
          <li class="list-group-item">
            <a href="pc-laptop.php" style="color: #000; text-decoration: none;">
              <i class="bi bi-pc-display"></i> PC / laptop
            </a>
          </li>
          <li class="list-group-item active">
            <a href="tools.php" style="color: #fff; text-decoration: none;">
